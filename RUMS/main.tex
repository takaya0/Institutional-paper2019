...
\begin{figure}[htbp]
    \begin{minipage}{0.32\hsize}
        \centering
        \includegraphics[width = 5.5cm]{MNIST_sample1.png}
        \caption{数字の5}
    \end{minipage}
    \begin{minipage}{0.32\hsize}
        \centering
        \includegraphics[width = 5.5cm]{MNIST_sample2.png}
        \caption{数字の9}
    \end{minipage}
    \begin{minipage}{0.32\hsize}
        \centering
        \includegraphics[width = 5.5cm]{MNIST_sample3.png}
        \caption{数字の6}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 10.0cm]{Logstic_regression_MNIST.png}
    \caption{$\alpha = 0.001$とした時の, MNSIT実験の結果}
\end{figure}
...
\begin{Definition+}(回帰型ニューラルネットワーク)\\
    ...
    \begin{align*}
        ...
        \begin{array}{l}
            f(x) = W^{\top}g_{K}\circ g_{K - 1}\cdots\circ g_{1}(x) - b, g_{i} = \mu(W_{i}x + b_{i})\\
...
\begin{Definition+}(分類型ニューラルネットワーク)\\
    ...
    \begin{align*}
        \Hil &= \left\{f:\X\to\Y~\middle|
        \begin{array}{l}
            f(x) = \psi(W g_{K}\circ g_{K - 1}\cdots\circ g_{1}(x) - b), g_{i} = \mu(W_{i}x + b_{i})\\
